# Regras do diretor — craft do Marcos (injetado no prompt do reader)

Uma regra por linha: `contexto -> direção musical`. PT ou EN. O reader continua
...
- situação retrô DIVERTIDA -> synth-pop oitentista
